...
namespace Kaiju
{
    namespace Compiler
    {
        ...
        bool compileToAST( const std::string& input, ASTNode& output, std::stringstream& log )
        {
            ...
            REGISTER_TYPE( Kaiju::Grammar::Class::Method::Definition::arguments, "class.method.definition.arguments", true );
            ...
            REGISTER_TYPE( Kaiju::Grammar::Class::Method::Call::arguments, "class.method.call.arguments", true );
            REGISTER_TYPE( Kaiju::Grammar::Class::Method::call, "class.method.call", true );
            REGISTER_TYPE( Kaiju::Grammar::Class::Method::call_statement, "class.method.call_statement", true );
            ...
            REGISTER_TYPE( Kaiju::Grammar::Directive::arguments, "directive.arguments", true );
