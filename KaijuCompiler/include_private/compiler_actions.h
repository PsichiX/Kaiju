...
namespace Kaiju
{
    namespace Compiler
    {
        namespace Actions
        {
            ...
            AST_GENERATOR_ACTION( Kaiju::Grammar::Class::Method::Definition::arguments );
            ...
            AST_GENERATOR_ACTION( Kaiju::Grammar::Class::Method::Call::arguments );
            AST_GENERATOR_ACTION( Kaiju::Grammar::Class::Method::call );
            AST_GENERATOR_ACTION( Kaiju::Grammar::Class::Method::call_statement );
            ...
            AST_GENERATOR_ACTION( Kaiju::Grammar::Directive::arguments );
