...
namespace XeCore
{
	namespace Common
	{
		...
		public:
			...
			struct Query
			{
				Query( QueryType t, bool& v ) : type( t ), value( (pointer)v ) {}
				Query( QueryType t, unsigned int& v ) : type( t ), value( (pointer)v ) {}
				Query( QueryType t, const char* v ) : type( t ), value( (pointer)v ) {}
				Query( QueryType t, int& v ) : type( t ), value( (pointer)v ) {}
				QueryType		type;
				pointer			value;
			};
